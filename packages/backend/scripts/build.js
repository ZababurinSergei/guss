...
async function build() {
    try {
        // Сначала собираем database package
        ...
        // Компилируем TypeScript с references
        console.log('🔨 Compiling TypeScript with project references...');
        ...
        if (fs.existsSync(migrationsSrc)) {
            await copyRecursive(migrationsSrc, migrationsDest);
        ...
        if (fs.existsSync(envExamplePath) && !fs.existsSync(envDestPath)) {
            ...
            console.log('✅ .env.example copied as .env');
        }
